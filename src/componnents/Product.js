...
export default class Product extends Component {
  ...
  render() {
    const {id,img,info,price,inCart,title} = this.props.product;
    return (
      <ProductWrapper className=" col-lg-3 col-9 mx-auto col-md-6  my-3">
        
        <div className="card">
          <div className="img-container p-5" onClick={()=>console.log("hello")}>
              <Link to="/details"> <img src={img} alt="product image" className="card-img-top"/> </Link>
